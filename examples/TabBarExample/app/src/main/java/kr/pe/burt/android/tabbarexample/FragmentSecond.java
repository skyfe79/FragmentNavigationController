 ...
 */
public class FragmentSecond extends AndroidFragment {
    ...
    protected View onCreateContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v.findViewById(R.id.next).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nv == null) return;
                nv.setPresentStyle(PresentStyle.ACCORDION_LEFT); //exclude NONE present style
                nv.presentFragment(new FragmentSecond());
            }
        });
        return v;
    }
